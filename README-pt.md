...
| :---: | --- |------------------------------------------------------------------------------------------------------------------------------------------------------------------| ------ |
| <img width="109" alt="starstruck-default" src="https://github.com/user-attachments/assets/d133ebb1-5460-4741-a036-754f362149cd"> | **Starstruck** | Criei um repositório que tenha **16 stars** ou [mais](#tiers).                                                                                              | Dificil |
| <img width="109" alt="QuickDraw_SkinTone1" src="https://github.com/user-attachments/assets/9a5c0ba0-226d-4a7b-911e-d9794c632863"> | **Quickdraw** | Feche um problema ou uma solicitação de pull em até 5 minutos após a abertura.                                                                                                       | Muito fácil |
| <img width="109" alt="pair-extraordinaire-default" src="https://github.com/user-attachments/assets/a7cc2270-94b0-4dd4-87c7-862fda8880e4"> | **Pair Extraordinaire** | Coautor em **uma** ou [mais](#tiers) solicitações de pull mescladas. (Requer GitHub Desktop App)                                                                                        | Dificil |
...
| <img width="109" alt="YOLO_Badge" src="https://github.com/user-attachments/assets/5a6f79d4-d71d-4a00-b7ef-a4fce93272f5"> | **YOLO** | Mesclou **pelo menos uma** solicitação de pull sem revisão de código.                                                                                                       | Fácil |
